...
function reducer(state, action) {
    ...
    switch (action.type) {
        ...
        case 'SELECT_NODE':
            if (selectedNode) {
                console.log(`[SELECT_NODE] id: ${selectedNode.id} x: ${selectedNode.x} y: ${selectedNode.y} order: ${selectedNode.order} depth: ${selectedNode.depth} parentId: ${selectedNode.parentId}`);
            }
